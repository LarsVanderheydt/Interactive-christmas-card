...
export default class Head {
  constructor() {
    ...
    const headGeom = new THREE.BoxBufferGeometry(16, 16, 16);
    const skinMat = new THREE.MeshLambertMaterial({color: Colors.skin, flatShading: true});
  ...
  Beard() {
    ...
    const beard11 = new THREE.Mesh(beard5Geom, Mat.whiteMat);
    ...
    const beardMerged = new THREE.Mesh(beardGeomMerged, Mat.whiteMat);
    beardMerged.castShadow = true;
    beardMerged.receiveShadow = true;

    const mouthGeom = new THREE.BoxGeometry(10, 4, 1);
    const mouth = new THREE.Mesh(mouthGeom, Mat.blackMat);
    mouth.position.set(0, 2, 8);
    mouth.castShadow = false;
    mouth.receiveShadow = true;

    const teethGeom = new THREE.BoxGeometry(10, 1, 1);
    const teeth = new THREE.Mesh(teethGeom, Mat.teethMat);
    ...
    const moustacheGeom = new THREE.BoxGeometry(14, 3, 3, 3);
  ...
  Glasses() {
    ...
    const glassesMat = new THREE.MeshPhongMaterial({color: Colors.glasses, flatShading: true});

    const frameGeomMerged = new THREE.Geometry();

    const frameOuterGeom = new THREE.CylinderGeometry(3, 3, 0.5, 32);
    const frameInnerGeom = new THREE.CylinderGeometry(2.7, 2.7, 0.5, 32);
    ...
    const frameBSP = new ThreeBSP(frameOuterGeom);
    const frameCutBSP = new ThreeBSP(frameInnerGeom);

    const frameintersectionBSP = frameBSP.subtract(frameCutBSP);
    const frameLeft = frameintersectionBSP.toMesh(glassesMat);
    ...
    const frameMidGeom = new THREE.BoxGeometry(2, .3, .5);
    const frameMid = new THREE.Mesh(frameMidGeom, glassesMat);
    ...
    const frameEndGeom = new THREE.BoxGeometry(1.5, .5, 1);
    const frameEndRight = new THREE.Mesh(frameEndGeom, glassesMat);
    ...
    const frameEndLeft = frameEndRight.clone();
    ...
    const frameSpokeGeom = new THREE.BoxGeometry(1, 0.5, 12);
    const frameSpokeRight = new THREE.Mesh(frameSpokeGeom, glassesMat);
    ...
    const frameSpokeLeft = frameSpokeRight.clone();
    ...
    const frameMerged = new THREE.Mesh(frameGeomMerged, glassesMat);
  ...
  Hair() {
    ...
    const hairGeomMerged = new THREE.Geometry();

    const hairFlatGeom = new THREE.BoxGeometry(10, 2, 18);

    const hair1 = new THREE.Mesh(hairFlatGeom, Mat.whiteMat);
    ...
    const hair2 = new THREE.Mesh(hairFlatGeom, Mat.whiteMat);
    ...
    const hair3 = new THREE.Mesh(hairFlatGeom, Mat.whiteMat);
    ...
    const hair4 = new THREE.Mesh(hairFlatGeom, Mat.whiteMat);
    ...
    const hair6 = new THREE.Mesh(hairFlatGeom, Mat.whiteMat);
    ...
    const hairFlatBackGeom = new THREE.BoxGeometry(18, 7, 6);
    ...
    const hair5 = new THREE.Mesh(hairFlatBackGeom, Mat.whiteMat);
    hair5.applyMatrix(new THREE.Matrix4().makeTranslation(0, - 4.5, - 6));
    hair5.updateMatrix();
    hairGeomMerged.merge(hair5.geometry, hair5.matrix);

    const hairMerged = new THREE.Mesh(hairGeomMerged, Mat.whiteMat);
  ...
  Eyes() {
    ...
    const eyeWhiteGeom = new THREE.PlaneGeometry(2.5, 2.5);

    const eyeWhiteRight = new THREE.Mesh(eyeWhiteGeom, Mat.whiteMat);
    eyeWhiteRight.position.set(- 3.75, 0, 0);
    eyeWhiteRight.castShadow = false;
    eyeWhiteRight.receiveShadow = false;

    const eyeBlueGeom = new THREE.PlaneGeometry(1.5, 1.5);

    const eyeMat = new THREE.MeshPhongMaterial({color: Colors.eye, flatShading: true});
    ...
    const eyePupilGeom = new THREE.PlaneGeometry(1, 1);
    ...
    const eyeWhiteLeft = new THREE.Mesh(eyeWhiteGeom, Mat.whiteMat);
  ...
  EyeBrows() {
    ...
    const eyeBrowGeom = new THREE.BoxGeometry(4, 1, 1);
  ...
  Hat() {
    ...
    const hatMat = new THREE.MeshPhongMaterial({color: Colors.hat, flatShading: true});

    const bandGeom = new THREE.TorusGeometry(9, 2, 16, 100);
    const bigConeGeom = new THREE.CylinderGeometry(1, 11, 12, 15);
    const smallConeGeom = new THREE.CylinderGeometry(0.8, 3, 9, 32);
    const hatDingleGeom = new THREE.SphereGeometry(1.5, 8, 8);
  ...
  Freckles() {
    ...
    const frecklesMat = new THREE.MeshLambertMaterial({color: Colors.freckles, flatShading: true});
    const frecklesGeomMerged = new THREE.Geometry();

    const frecklesGeom = new THREE.PlaneGeometry(0.5, 0.5);

    const freckle1 = new THREE.Mesh(frecklesGeom, frecklesMat);
  ...
  Features() {
    const earGeom = new THREE.BoxBufferGeometry(1.5, 3, 1.5);
    const skinMat = new THREE.MeshLambertMaterial({color: Colors.skin, flatShading: true});
    ...
    const noseGeom = new THREE.CylinderGeometry(1, 2, 4, 4);
