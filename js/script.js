{
  ...
  class Head {
    constructor() {
      ...
      let beard5 = new THREE.Mesh(beard2Geom, auburnMat);
      ...
      let beard6 = new THREE.Mesh(beard3Geom, auburnMat);
      ...
      let beard9 = new THREE.Mesh(beard4Geom, auburnMat);
      ...
      let beard10 = new THREE.Mesh(beard5Geom, auburnMat);
      ...
      let beard11 = new THREE.Mesh(beard5Geom, auburnMat);
      ...
      let beardMerged = new THREE.Mesh(beardGeomMerged, auburnMat);
      ...
      let teeth = new THREE.Mesh(teethGeom, whiteMat);
      ...
      let hair1 = new THREE.Mesh(hairFlatGeom, auburnMat);
      ...
      let hair2 = new THREE.Mesh(hairFlatGeom, auburnMat);
      ...
      let hair3 = new THREE.Mesh(hairFlatGeom, auburnMat);
      ...
      let hair4 = new THREE.Mesh(hairFlatGeom, auburnMat);
      ...
      let hair5 = new THREE.Mesh(hairFlatBackGeom, auburnMat);
      ...
      let hairTuft1 = new THREE.Mesh(hairTuftGeom, auburnMat);
      ...
      let hairTuft2 = new THREE.Mesh(hairTuftGeom, auburnMat);
      ...
      let hairTuft3 = new THREE.Mesh(hairTuftGeom, auburnMat);
      ...
      let hairMerged = new THREE.Mesh(hairGeomMerged, auburnMat);
      ...
      let eyeWhiteRight = new THREE.Mesh(eyeWhiteGeom, whiteMat);
      ...
      let eyeWhiteLeft = new THREE.Mesh(eyeWhiteGeom, whiteMat);
      ...
      this.eyeBrowRight = new THREE.Mesh(eyeBrowGeom, whiteMat);
      ...
      this.eyeBrowLeft = new THREE.Mesh(eyeBrowGeom, whiteMat);
      ...
      let freckle1 = new THREE.Mesh(frecklesGeom, brownMat);
      ...
      let freckledMerged = new THREE.Mesh(frecklesGeomMerged, brownMat);
      ...
      let earRight = new THREE.Mesh(earGeom, skin2Mat);
      earRight.position.set(-8.5, 1, 0);
      earRight.castShadow = true;
      earRight.receiveShadow = false;

      let earLeft = new THREE.Mesh(earGeom, skin2Mat);
      ...
      let nose = new THREE.Mesh(noseGeom, skin2Mat);
    ...
    idle() {
      ...
      blinkLoop();
      //AANPASSEN NAAR ALGEMENE LOOP FUNCTIE ____GLOBAAL
